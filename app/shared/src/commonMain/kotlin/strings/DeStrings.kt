...
val DeStrings = Strings(
    reload = "Neu laden",
    crashedExplainer = "Die Serververbindung wurde unerwartet geschlossen, dies beutetet vermutlich, dass deine Internetverbindung abgebrochen ist oder, dass du einen neuen Tab geöffnet hast",
